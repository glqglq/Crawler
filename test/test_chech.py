...
while True:
    try:
        ...
        urllib2.install_opener(opener)
        proxy = urllib2.urlopen(r'http://www.xdaili.cn/ipagent//privateProxy/getDynamicIP/DD20175228809744WXT/4ba606acaaf911e6802371d9ec16a600?returnType=1').read().split()[0]
    except Exception,e:
        print proxy
