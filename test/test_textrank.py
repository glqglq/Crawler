...
start = time.time()
tr4w.analyze(text=content1, lower=True, window=2)  # py2中text必须是utf8编码的str或者unicode对象，py3中必须是utf8编码的bytes或者str对象
...
start = time.time()
tr4w.analyze(text=content2, lower=True, window=2)  # py2中text必须是utf8编码的str或者unicode对象，py3中必须是utf8编码的bytes或者str对象
...
tr4s.analyze(text=content2, lower=True, source = 'all_filters')
...
start = time.time()
tr4w.analyze(text=content3, lower=True, window=2)  # py2中text必须是utf8编码的str或者unicode对象，py3中必须是utf8编码的bytes或者str对象
...
tr4s.analyze(text=content3, lower=True, source = 'all_filters')
